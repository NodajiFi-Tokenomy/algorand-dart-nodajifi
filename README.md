...
The call to add a transaction may be performed multiple times, each time adding a new transaction to the atomic group. 
...
<!-- The pub.dev badges have been removed as this package is now hosted on GitHub to avoid confusion with the original package. -->
